...
public class IntersectSegment {
	...
	public boolean isIntersect(Segment s1, Segment s2) {
		...
		if(s1.x1 == s2.x1 && s1.y1 == s2.y1)	return true;
		if(s1.x2 == s2.x2 && s1.y2 == s2.y2)	return true;
		// case 2 : s1.x1 > s2.x1 but s1.x2 < s2.x2
		if(s1.x1 < s2.x1 && s1.x2 > s2.x2)	return true;
		if(s1.x1 > s2.x1 && s1.x2 < s2.x2)	return true;
		if(s1.x1 < s2.x2 && s1.x2 > s2.x1)	return true;
		if(s1.x1 > s2.x2 && s1.x2 < s2.x1)	return true;
		return false;
	}
}
