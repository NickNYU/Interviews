...
public class MostCloesetPoint {
	public static List<Point> findMostCloseset(List<Point> points, int k) {
		...
		for(Point point : points) {
			...
			if(!map.containsKey(distance))	map.put(distance, new ArrayList<Point> ());
	...
	public static void main(String[] args) {
		List<Point> points = Arrays.asList(new Point(-2, -4), new Point(0, 0), new Point(10, 15), new Point(5, 6), new Point(7, 8),
				new Point(-10, -30), new Point(4,9));
